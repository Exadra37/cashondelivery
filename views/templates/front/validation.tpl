...
<form action="{$link->getModuleLink('cashondelivery', 'validation', [], true)}" method="post"><input type="hidden" name="confirm" value="1" />
...
<thead><th>{l s='Cash on delivery (COD) payment' mod='cashondelivery'}</th><th style="text-align:center;width:115px">Total</th>
<tr>
<td>
...
<tr>
<td>{l s='Surcharge for cash on delivery' mod='cashondelivery'}, <span style="font-style:oblique;color:#555">( {l s='this amount will be added to the shipping' mod='cashondelivery'} )</span></td>
<td style="text-align:center">{convertPrice price=$dobirecne}</td>
</tr>
<tr>
<td rowspan="2"><p style="margin-top:4%">{l s='Total Order' mod='cashondelivery'},<em style="color:#555">
{if $use_taxes == 1}
...
<br/><br/>
<p><b>{l s='Please confirm your order by clicking \'I confirm my order\'' mod='cashondelivery'}.</b></p>
<p class="cart_navigation">
<a href="{$link->getPageLink('order.php', true)}?step=3" class="button_large">{l s='Other payment methods' mod='cashondelivery'}</a>
<input type="submit" name="submit" value="{l s='I confirm my order' mod='cashondelivery'}" class="exclusive_large"/></p></form>