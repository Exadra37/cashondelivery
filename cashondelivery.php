...
class CashOnDelivery extends PaymentModule
{
    ...
    {  
        ...
        if (!$this->isAllowedCarrier($params['cart']->id_carrier)) {
    ...
    {
        // TODO:: build this html from template file amd use Cache to retrieve it
